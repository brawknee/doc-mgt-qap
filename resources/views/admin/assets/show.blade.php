            ...
            <table class="table table-bordered table-striped">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl={{ route('admin.assets-histories.index') }}?doc_name={{ $asset->name }}&choe=UTF-8" class="" style="width: 300px" alt="">
                        </td>
                    </tr>
                </tbody>
            </table>
